...
function DecodedSummaryCard({ decoded }: { decoded: DecodedSummary }) {
  ...
  const platformStr =
    platformParts.length > 0 ? platformParts.join(" · ") : null;
  ...
  const sections: InfoSection[] = [
    {
      ...
      rows: [
        ...
        { label: "App Version", value: formatValue(bi.appVersion) },
        {
          ...
          value: formatValue(bi.pdfViewerEnabled),
        },
        ...
        { label: "Do Not Track", value: formatValue(bi.doNotTrack) },
        {
          ...
          value: formatValue(bi.globalPrivacyControl),
        },
    ...
    },
    {
      ...
      rows: [
        { label: "Screen Resolution", value: `${sd.width} × ${sd.height}` },
        {
          ...
          value: `${sd.availWidth} × ${sd.availHeight}`,
        },
        {
          label: "Viewport Size",
          value: `${sd.innerWidth} × ${sd.innerHeight}`,
        },
        {
          label: "Device Pixel Ratio",
          value: formatValue(sd.devicePixelRatio),
        },
      ...
      rows: [
        ...
        ...(hw.gpu
          ? [
              ...
              {
                label: "WebGL Version",
                value: formatValue(hw.gpu.webglVersion),
              },
              {
                label: "Shading Language Version",
                value: formatValue(hw.gpu.shadingLanguageVersion),
              },
              {
                label: "Max Texture Size",
                value: formatValue(hw.gpu.maxTextureSize),
              },
              {
                label: "Max Vertex Attribs",
                value: formatValue(hw.gpu.maxVertexAttribs),
              },
              {
                label: "Antialiasing",
                value: formatValue(hw.gpu.antialiasing),
              },
              {
                label: "WebGL Extensions",
                value: formatValue(hw.gpu.extensions),
              },
            ]
          : []),
      ],
    },
    {
      ...
      rows: [
        ...
        { label: "Effective Type", value: formatValue(net.effectiveType) },
        {
          ...
          value: net.downlink
            ? `${net.downlink} Mbps`
            : formatValue(net.downlink),
        },
        {
          label: "RTT",
          value: net.rtt ? `${net.rtt} ms` : formatValue(net.rtt),
        },
      ...
      <div>
        ...
        <div className="mt-6 rounded-md border border-blue-500/50 bg-blue-500/10 px-4 py-3">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-sm">You are viewing a shared browser profile.</p>
